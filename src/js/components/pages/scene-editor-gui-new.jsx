    ...
    render: function() {
                        ...
                        gridJSX = (
                            <div>
                                ...
                                <span>
                                    ...
                                    <NumericInput min={1} value={target.cols} step={1} precision={0} snap 
                                                  style={{
                                                    input: {
                                                        width: "100px",
                                                        color: 'black'
        ...
        return (
            <div className="mf-empty-grid-component">
                <span className = "mf-inlineAll" style ={{width: "100%", height: "100%"}}> 
                ...
                <div className="mf-gui-propsbar mf_fs_widget_padding_remove"> 
                    <span className="mf-inlineAll">
                        <div>Selected Target: {this.state.selectedIndex}</div>   
                        <div>Rows: {this.state.scene.targets[this.state.selectedIndex].rows}</div>   
                        <div>Cols: {this.state.scene.targets[this.state.selectedIndex].cols}</div>    
                    </span>
                </div>
